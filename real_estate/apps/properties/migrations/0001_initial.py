# Generated by Django 3.2.7 on 2022-06-16 15:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', django_countries.fields.CountryField(default='MW', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Lilongwe', max_length=255, verbose_name='City')),
                ('postal_code', models.CharField(default='P.O Box 590', max_length=100, verbose_name='Postal Address')),
                ('street_address', models.CharField(default='MZ74 Luwinga', max_length=150, verbose_name='Street Address')),
                ...
                ('tax', models.DecimalField(decimal_places=2, default=0.15, help_text='15% property tax charged', max_digits=6, verbose_name='Propert Tax')),
                ...
                ('advert_type', models.CharField(choices=[('For Sale', 'For Sale'), ('For Rent', 'For Rent'), ('Auction', 'Auction')], default='For Rent', max_length=50, verbose_name='Advert Type')),
