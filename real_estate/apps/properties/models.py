...
class Property(TimeStampedUUIDModel):
    ...
    country = CountryField(verbose_name=_("Country"), default="MW", blank_label="(select country)")
    city = models.CharField(verbose_name=_("City"), max_length=255, default="Lilongwe")
    postal_code = models.CharField(verbose_name=_("Postal Address"), max_length=100, default="P.O Box 590") 
