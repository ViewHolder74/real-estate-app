...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_('Phone Number'),max_length=30, default='+265998108842')
    about_me = models.TextField(verbose_name=_('About Me'), default='say something about yourself')
    license = models.CharField(verbose_name=_('Real Estate Licence'), max_length=20, blank=True, null=True)
    ...
    country = CountryField(verbose_name=_('Country'), default='MW', blank=False, null=False)
    city = models.CharField(verbose_name=_('City'), max_length=180, default="Lilongwe", blank=False, null=False)
    ...
    numb_reviews = models.IntegerField(verbose_name=_('Number of Reviews'), default=0, null=True, blank=True)
